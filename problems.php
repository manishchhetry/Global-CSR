...
while($row=mysql_fetch_array($r))
{
    ...
    $image=$row[8];
    $status=$row[9];
    echo "<tr><td>$Id</td><td>$name</td><td>$email</td><td>$title</td><td>$problem</td><td>$neededamount</td><td>$date</td><td>$raisedamount</td><td><a href='description.php'><a href='description.php?id=$Id'><img src='$image' width='50' height='50'></a></td><td> <span><a href='insert.php?id=$Id'><i class='fa fa-thumbs-up' aria-hidden='true'></i></a></span><span><a href='delete1.php?id=$Id'><i class='fa fa-trash' aria-hidden='true'></i></a></span> </td><td>$status</td></tr>";
}
?>
</div></tr></table></center>
