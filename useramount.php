...
<div class=>
    ...
    <center>
    <table><tr><td>Card Number</td><td>exp</td><td>cvc</td><td>Card Owner</td><td>Email</td><td>Amount</td><td>Individual/Corporate</td><td>Name</td><td>Email</td></tr>
<div align="center">
<?php
mysql_connect("localhost","root");
mysql_select_db("fund");
$email=$_COOKIE['user'];
$r=mysql_query("select  *from amount where demail='$email'");
while($row=mysql_fetch_array($r))
{
    ...
    $raisedamount=$row[7];
    $image=$row[8];
    echo "<tr><td>$Id</td><td>$name</td><td>$email</td><td>$title</td><td>$problem</td><td>$neededamount</td><td>$date</td><td>$raisedamount</td><td>$image</td></tr>";
}
?>
</div></tr></table></center>
