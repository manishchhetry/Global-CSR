                       ...
                       <h2>   Global CSR</h2>
                        ...
                        <nav class="site-navigation d-flex justify-content-end align-items-center">
                            <ul class="d-flex flex-column flex-lg-row justify-content-lg-end align-content-center">
                                ...
                                <li><a href="upload.php">Post</a></li>
                                <li><a href="sa.php">Problems</a></li>
                                <li><a href="successstories.php">Success Stories</a></li>
                                <li><a href="description1.php">Description</a></li>
                            </ul>
                        </nav><!-- .site-navigation -->
...
-->
      ...
      <img id='img-upload'/>
            <video width="500" height="500" controls style="position:absolute; left: 600px;top:-10px;">
...
<input type="text" name="t3" placeholder="Problem Title" required=""><br><br>
<textarea placeholder="Problem Description" rows="5" cols="65" name="ta1"></textarea><br><br>
<input type="text" name="t2" placeholder="Enter The amount You needed" required=""><br><br><br>
     <span class="input-group-btn">
      Upload Image
                <span class="btn btn-default btn-file">
                   Upload pictures <input type="file" name='file'>
                </span>
            </span><br><br>
...
<!--</div>-->
<!--</div>-->
            <h2 style="position:absolute; left: 600px;top:-10px;">Problems...</h2> 
   <img id='img-upload'/><video width="500" height="500" controls style="position:absolute; left: 840px;bottom:-300px;">
  <source src="images/2.mp4" type="video/mp4" >
  <source src="images/1.mp4" type="video/mp4">
...
if(isset($_POST['Post']))
{
    ...
    $q=mysql_query("insert into problem values('$h','$name','$email','$title','$problem','$amount','$date','','$filepath','waiting list')");
    if(($q) or die(mysql_error()))
    {
