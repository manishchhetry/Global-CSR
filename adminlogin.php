...
<div class=>
    ...
    <center>
    <table><tr><td>Username</td><td>Email</td><td>Usertype</td><td>
    Action</td>
<div align="center">
<?php
...
while($row=mysql_fetch_array($r))
{
    ...
    $email=$row[1];
    $user=$row[2];
    echo "<tr><td>$name</td><td>$email</td><td>$user</td><td> <span><a href='delete.php?id=$email'><i class='fa fa-trash' aria-hidden='true'></i></a></span> </td></tr>";
}
?>
</div></tr></table></center>
